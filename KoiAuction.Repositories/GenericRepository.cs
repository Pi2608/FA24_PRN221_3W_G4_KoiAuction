...
namespace KoiAuction.Repositories
{
    ...
    {
        protected FA24_PRN221_3W_G4_KoiAuctionContext _context;

        public GenericRepository()
        {
            _context ??= new FA24_PRN221_3W_G4_KoiAuctionContext();
        }

        public GenericRepository(FA24_PRN221_3W_G4_KoiAuctionContext context)
        {
            _context = context;
        }
